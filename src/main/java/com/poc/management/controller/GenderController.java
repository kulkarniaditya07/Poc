...
public class GenderController {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<RestApiResponse<String>> deleteGender(@PathVariable("id") Long id){
        return ResponseEntity.status(HttpStatus.OK).body(genderService.removeGender(id));
    }
